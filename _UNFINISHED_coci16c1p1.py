...
# Nikola is now wondering what would happen if 26 wizards labeled with uppercase letters of the English alphabet 
# from A to Z began fighting in duels for the fondness of the Elder Wand. If we know the label of the wizard that the wand 
# had obeyed before all duels and the outcomes of all N duels that were held one after another, answer the following questions:
...
# Correct answer to the first question is worth 2 points and the correct answer to the second question is worth 3 points. 
# If you do not know how to solve some part of the task, then print any value in the corresponding line.