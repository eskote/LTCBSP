...
# Each of the following N lines contains an integer P i ( 0 ≤ P i ≤ 10 000 ) , 
# the number of megabytes spent in each of the first N months of using the plan. 
# Numbers P i will be such that Pero will never use more megabytes than he actually has.
